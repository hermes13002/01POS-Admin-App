...
import 'package:onepos_admin_app/features/bill/data/models/bill_model.dart';
...
class BillsScreen extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // mock data
    final bills = useMemoized(
      () => [
        BillModel(
          id: '1',
          title: 'Electricity Bill',
          billType: 'Auto billing',
          amount: 35000,
        ...
        BillModel(
          id: '2',
          title: 'Water Bill',
          billType: 'Manual payment',
          amount: 15000,
          isActive: false,
        ),
        BillModel(
          id: '3',
          title: 'Waste Management Bill',
          billType: 'Auto billing',
          amount: 15000,
          isActive: false,
        ),
                              ...
                              Expanded(
                                child: Text(
                                  ...
                                  style: GoogleFonts.poppins(
                                    fontSize: 14,
                                    color: AppTheme
                                        .textPrimary, // the design has slightly lighter text but normal fits "Title" size.
                                  ),
                                ),
                              ),
                              Row(
